...
<script language="javascript">
function Botao1(){
    document.FCadastroCurriculum.action="CUsr.class.php?acao=cadastrar_exp";
    document.forms.FCadastroCurriculum.submit();    
}

function Botao2(){
    document.FCadastroCurriculum.action="CUsr.class.php?acao=cadastrar_exp2";
    document.forms.FCadastroCurriculum.submit();    
}
</script>
	<style type="text/css">
...
<body bgcolor='white'>
  ...
  <tr>
    <td><div align="center"><input class="botao" type="button" onclick="Botao1()" value="Nova Experiência" > </div></td>
  	<td><div align="center"><input class="botao" type="submit" onclick="Botao2()" value="Concluir Cadastro" > </div></td>
</tr>
</table>
</div>
</form>
